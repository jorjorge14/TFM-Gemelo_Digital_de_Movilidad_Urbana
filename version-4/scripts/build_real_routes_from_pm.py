...
GLOBAL_SCALE = 1                # Escala global de demanda (para reducir la intensidad real a un 40 %)
MAX_VEH_PER_FLOW = 10000        # Límite máximo de vehículos por sensor e intervalo
...
# -------------------------
# Ejecución de duarouter. 
# Ejecuta duarouter para convertir flows en rutas completas.
# -------------------------
