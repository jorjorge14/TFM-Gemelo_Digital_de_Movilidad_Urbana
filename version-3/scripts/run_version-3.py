...
# --------------------------------------------------
# 7. Ejecución del vehículo de emergencias
# El script se conecta a SUMO por TraCI, introduce el vehículo de emergencias y aplica una primera prioridad semafórica básica
# --------------------------------------------------
print("7) Ejecutando vehículo de emergencia...")
subprocess.run(["python", "emergency_mvp.py"], cwd=ROOT / "scripts", check=True)